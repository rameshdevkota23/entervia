...
<!-- wp:heading {"level":4} -->
<h4 class="wp-block-heading"><?php echo esc_html__('Recent post', 'entervia'); ?></h4>
<!-- /wp:heading -->
...
<!-- wp:heading {"level":4} -->
<h4 class="wp-block-heading"><?php echo esc_html__('Tags', 'entervia'); ?></h4>
<!-- /wp:heading -->
...
<!-- wp:heading {"level":4} -->
<h4 class="wp-block-heading"><?php echo esc_html__('Categories', 'entervia'); ?></h4>
<!-- /wp:heading -->
